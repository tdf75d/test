...
def wav():
    ...
    h=64500
    for i in range(data.shape[0]//10):
        channel1[i]=decToBinList(round((1.65+channel1[i]/(h//2)*1.65)*256/3.3))
        channel2[i] =decToBinList(round((1.65+channel2[i]/(h//2)*1.65)*256/3.3))
